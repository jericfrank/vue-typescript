...
/**
 * @author Saki
 * @date 2019-03-28 20:45:55
 * @Last Modified by: Saki
 * @Last Modified time: 2019-05-01 19:17:37
 * 
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            maxHandler(action) {
                this.$refs.scheduler.schedulerEngine.eventStore.query((task) => task.eventType === 'Meeting').forEach((task) => task.duration = Math.min(task.duration, 1));
