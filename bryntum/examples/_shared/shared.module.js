import { WidgetHelper,AjaxHelper,DomHelper,IdHelper,Tooltip,Toast,BrowserHelper,StringHelper,LocaleManager,Localizable,DataGenerator,Fullscreen,Events,GlobalEvents,VersionHelper,EventHelper,Panel,ResizeHelper,Rectangle } from '../../build/scheduler.module.js?433953';
...
const
    ...
    isModule = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?433953')) || (pathName.endsWith('index.html') && isOnline),
...
class CodeEditor extends Panel {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?433953' : isUmd ? 'app.umd.js?433953' : 'app.js?433953',
                    items    : [
                        isModule ? 'app.module.js?433953' : isUmd ? 'app.umd.js?433953' : 'app.js?433953'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?433953' : isUmd ? 'app.umd.js?433953' : 'app.js?433953') {
        const me = this;
        ...
        if (filename.endsWith('.js?433953')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?433953')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?433953') ? 'css' : 'javascript'};charset=utf-8,${escape(this.pre.innerText)}`;
    }
    ...
    static async addToPage() {
        ...
        if (document.head.querySelector('[href$="app.css?433953"]')) {
            filesStore.add({ text : 'resources/app.css?433953', value : 'resources/app.css?433953' });
        }
